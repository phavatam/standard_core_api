...
namespace IziWork.Business.Repositories
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class, IEntity, new()
    {
        ...
        public void GetCurrentUser()
        {
            ...
            {
                var users = _context.Users.Where(x => x.Id == currentUserId && x.IsDeleted != null && !x.IsDeleted.Value && x.IsActivated != null && x.IsActivated.Value);
                if (users != null)
                {
                    ...
                    foreach(var userInDept in userInDepartment)
                    {
                        ...
                        if (currentRole != null)
                            userInDepartmentRoleList.AddRange(_mapper.Map<List<UserDepartmentRoleMappingDTO>>(currentRole));
        ...
        public T Add(T entity)
        {
            ...
            {
                softStatusEntity.Status = StatusConst.NEW;
            }
