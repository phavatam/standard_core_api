...
namespace IziWork.Common.Constans
{
    public static class MessageConst
    {
        ...
        public static readonly string HAS_NOT_BEEN_ASSIGNED_DEPARTMENT = "HAS_NOT_BEEN_ASSIGNED_DEPARTMENT";
        ...
        public static class WORKFLOW
        {
            ...
            public static readonly string CANNOT_FIND_APPROVER_ID_IN_NEXT_STEP = "CANNOT_FIND_APPROVER_ID_IN_NEXT_STEP";
            public static readonly string CANNOT_FIND_ROLE_IN_NEXT_STEP = "CANNOT_FIND_ROLE_IN_NEXT_STEP";
            ...
            public static readonly string CANNOT_FIND_CURRENT_STEP = "CANNOT_FIND_CURRENT_STEP";
            public static readonly string CANNOT_FIND_NEXT_STEP = "CANNOT_FIND_NEXT_STEP";
            ...
            public static readonly string STATUS_NOT_FOUND = "STATUS_NOT_FOUND";
        }
